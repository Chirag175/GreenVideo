...
else // If the user isn't logged in, then the entire Login/SignUp page is displayed enabling the user to login or signup if not registered previously.
{
	...
	<head>
		...
		<title>Login/SignUp - GreenVideo (International)</title>
		<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
	...
	<body style="background-image:url(images/bgimage.jpg)">
		<nav class="navbar fixed-top navbar-light bg-dark">
	  		<a class="navbar-brand" href="greenvideo_INT.php">
		...
		<div class="container">
			...
			<div class="card bg-dark">
				<div class="card-body">
					...
					<form align="center" method="post" action="insert.php" class="form1" id="signup">
						...
						<input type="text" name="zipcode" pattern="[0-9]+" id="zipcode" placeholder="Zip Code" class="feedback-input" required>
						<select class="feedback-input" style="width: 50%; float: left; text-align-last:center;" id="cc" placeholder="Country Code">
							<option>Choose a Country first!</option>
						</select>
						<input type="text" name="phone" id="phone" pattern="[0-9]{5,12}" placeholder="Phone Number" class="feedback-input" style="width: 50%; float: right;" required>
		...
		<div class="row">
			...
			<div class="col-sm-4" style="text-align: center;">
				<a href="greenvideo_INT.php" style="text-decoration: none; color: white;">
