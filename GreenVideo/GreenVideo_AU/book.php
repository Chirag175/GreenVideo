...
<head>
	...
	<title>Book - GreenVideo (Australia)</title>
...
<body>
	...
	else
	{
		...
		if ($book[0] == 'm') {
			...
			$price_buy=$record['price'];
			$price_rent=($price_buy*0.1)+0.001;
						...
						<div class='card-body'>
							...
							<div>
			    				...
			    				<form align='center' name='booktype' id='booktype' method='post' action='finalbook.php'>
				    				...
				    				<hr align='right' width='47.5%' style='margin-right: 27.5px;'>
				    				<br>
				    				<input name='btype' id='btype' type='submit' class='btn btn-outline-danger' value='Buy - $price_buy AUD'/>
			    					<input name='btype' id='btype' type='submit' class='btn btn-outline-success' value='Rent - $price_rent AUD/day'></input>
			    				</form>
							</div>
						</div>
					</div>
						...
						<div class='card-body'>
							...
							<div>
			    				...
			    				<form align='center' name='booktype' id='booktype' method='post' action='finalbook.php'>
				    				...
				    				<hr align='right' width='47.5%' style='margin-right: 27.5px;'>
				    				<br>
				    				<input name='btype' type='submit' class='btn btn-outline-danger' value='Buy - $price_buy AUD'/>
			    					<input name='btype' type='submit' class='btn btn-outline-success' value='Rent - $price_rent AUD/day'/>
			    				</form>
							</div>
						</div>
					</div>
